...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--Retrieve slideshow from https://www.youtube.com/watch?v=ngldKCSXA6U -->
    <!--Retrieve slideshow from https://www.youtube.com/watch?v=Fw1X7HLZfos -->
<div id="cutable">
    <h1>Contact Us</h1>
...
<table>
    ...
    <tr>
        <td>
          ...
          <td class="submit"><asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" CssClass="btn"   /></td>
